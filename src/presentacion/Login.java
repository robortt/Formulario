...
public class Login {
	...
	private void initialize() {
		...
		ActionListener listenEntrar = new ActionListener(){
			public void actionPerformed(ActionEvent evt){
					administrador.buscarAdmin(txtFieldUser.getText());
					String pswd = administrador.getPersona().getPswd();
					if (textFieldPass.getText() == pswd){
		...
		btnEntrar.addActionListener(listenEntrar);
